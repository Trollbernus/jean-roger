	...
	<body>
		...
		<section><article>
			...
			<p>Est-ce que cela convient ?</p>
				...
				<form method="post" action="pol_confirmer_modif_archive_sujet.php" enctype="multipart/form-data">
					<input type="hidden" name="idsujet" value=<?php echo $idsujet; ?>>
					<input type="hidden" name="nouvel_archivage" value="<?php echo $nouvel_archivage; ?>">
					<p>
