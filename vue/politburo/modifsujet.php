	...
	<body>
		...
		<section><article>
			<h1><?php
				...
				// }
			?></h1>
			<p><a class="politburo" href="pol_index.php?section=formulairesujet&id_sujet=<?php echo $idsujet; ?>">Modifier les propriétés du sujet</a></p>
			...
			foreach($messages as $message)
			{
				...
				<aside>
					...
					<p><br/> <a href="pol_index.php?section=formulairemessage&id_message=<?php echo $message['id']; ?>">Modifier ce message</a> </p>
 				</aside>
 				<p>
	 				<?php  
						echo $message['texte']; 
