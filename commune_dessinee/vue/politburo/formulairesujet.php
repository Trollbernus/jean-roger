					...
					<p class="politburo"> Modifier ce message : <br/>
						<fieldset>
							<form method="post" action="pol_modif_message.php" enctype="multipart/form-data">
								<p><input type="checkbox" value="1" name="mail" id="mail" /> <label for="case">Modifier l'email</label></p>
								<p><input type="checkbox" value="1" name="lien" id="lien" /> <label for="case">Modifier le lien</label></p>
								<p><input type="checkbox" value="1" name="texte" id="texte" /> <label for="case">Modifier le texte</label></p>
								<p><input type="checkbox" value="1" name="image" id="image" checked="checked" /> <label for="case">Modifier l'image</label></p>
