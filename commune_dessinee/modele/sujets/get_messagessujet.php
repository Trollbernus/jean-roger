...
// autorise quelques balises pour l'affichage du texte
function format_message($message)
{
  $smessage=$message;
  //$smessage=htmlspecialchars($message);

  $smessage=str_replace('&lt;br/&gt;', '<br/>', $smessage);
  $smessage=str_replace('&lt;br /&gt;', '<br/>', $smessage);

  $smessage=str_replace('&lt;em&gt;', '<em>', $smessage);
  $smessage=str_replace('&lt;/em&gt;', '</em>', $smessage);

  $smessage=str_replace('&lt;u&gt;', '<u>', $smessage);
  $smessage=str_replace('&lt;/u&gt;', '</u>', $smessage);

  $smessage=str_replace('&lt;i&gt;', '<i>', $smessage);
  $smessage=str_replace('&lt;/i&gt;', '</i>', $smessage);

  $smessage=str_replace('&lt;b&gt;', '<b>', $smessage);
  $smessage=str_replace('&lt;/b&gt;', '</b>', $smessage);
